...
public class MoveMaker {
	...
	private void initMap(){
		...
		map.put(new Bomb().getKey() + new Hazelnut().getKey(), new CandyMove(grid));
		map.put(new Bomb().getKey() + new Cherry().getKey(), new CandyMove(grid));
		...
		map.put(new Hazelnut().getKey() + new Bomb().getKey(), new CandyMove(grid));
		map.put(new Hazelnut().getKey() + new Hazelnut().getKey(), new CandyMove(grid));
		map.put(new Hazelnut().getKey() + new Cherry().getKey(), new CandyMove(grid));
		...
		map.put(new Cherry().getKey() + new Bomb().getKey(), new CandyMove(grid));
		map.put(new Cherry().getKey() + new Hazelnut().getKey(), new CandyMove(grid));
		map.put(new Cherry().getKey() + new Cherry().getKey(), new CandyMove(grid));
	}
